...
<div>
    ...
    <form action="POST" @submit.prevent>
        <label for="date_delivery" >Date de livraison</label><br>
        <input type="text" name="date_delivery" id="date_delivery" v-model="orderUpdate.date_delivery"><br>
        <label for="products_id">Produits</label>
        <input type="text" name="products_id" id="products_id" v-model="orderUpdate.products_id"><br>
        <label for="status"></label>
            <select name="status" v-model="orderUpdate.status">
              <option></option>
